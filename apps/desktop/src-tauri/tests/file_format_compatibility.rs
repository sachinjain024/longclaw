...
use longclaw_desktop_lib::core::storage::{content_hash, parse_ticket, patch_ticket_title};
use longclaw_desktop_lib::core::ErrorCode;
...
fn v1_app_writes_use_the_reserved_local_human_actor() {
    ...
    assert!(!next.contains("name: LongClaw desktop UI"));
}
