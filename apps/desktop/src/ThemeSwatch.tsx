 ...
 * (`components.md:292-297`, `screen-specs.md:126-132`). The palette's theme rows
 * carry the miniature of it (`screen-specs.md:327`); the theme picker wears it
 * at 44×28.
 *
 ...
 * (`components.md:251`, `screen-specs.md:71`) — the only place another
