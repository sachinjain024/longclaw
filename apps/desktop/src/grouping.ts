 ...
 *   statuses that have tickets (`screen-specs.md:183-184`);
 ...
 * have to agree with what it drew (`screen-specs.md:149`).
 *
 ...
 * that is what keeps it off the board (`screen-specs.md:164`) without either
