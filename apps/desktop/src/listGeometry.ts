...
/** `--lc-size-row`: the height `.list-row` is pinned to (`screen-specs.md:189`). */
export const ROW_HEIGHT = 36;
/** `--lc-space-7`: the sticky group header (`screen-specs.md:185`). */
 ...
 * group (`screen-specs.md:219-223`): every other group is rendered because it has
 * tickets in it.
 */
