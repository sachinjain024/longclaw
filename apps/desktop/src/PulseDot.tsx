 ...
 *
 * Part of the acknowledgement `acknowledgement.ts` describes, and shared by the board
 ...
 *
 * Rendered only while the mark is acknowledged, which is the caller's condition:
 * the
 * ring and the footer are governed by the same `isAcknowledged` and belong to the row.
 */

import { isPulsing, type ExternalMark } from "./acknowledgement";
