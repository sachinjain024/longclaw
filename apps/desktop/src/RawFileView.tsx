 ...
 * line that broke it, and the two ways out (`screen-specs.md:363-370`,
 * `states.md:95-104`).
 *
...
export function RawFileView(props: {
   ...
   * heading be the full path from the first frame (`screen-specs.md:365`).
   */
  path: string;
   ...
   * canonical. The heading is the *full* path (`screen-specs.md:365`), and the
