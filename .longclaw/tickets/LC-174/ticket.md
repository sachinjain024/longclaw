...
id: be18dfc0-1ae0-4bd9-a124-638e4374e68a
key: LC-174
...
- [x] Draw StatusDot at the documented r=5 / 1.6 stroke, with the filled states keeping their stroke <!-- longclaw:item=ck_6ee49a21 -->
- [x] Draw the urgent mark's bar and dot as the sheet's rects <!-- longclaw:item=ck_f7d23036 -->
- [x] Register status-* and priority-urgent in glyph-drift-guard.mjs so both stay put <!-- longclaw:item=ck_2fbf3aa7 -->
...
id: evt_e3dc1a29
kind: create
occurred_at: 2026-08-07T13:29:24.091Z
actor:
  type: agent
  id: claude-code
  name: Claude Code
...
id: evt_6525d423
kind: update
occurred_at: 2026-08-07T13:29:50.264Z
actor:
  type: agent
  id: claude-code
  name: Claude Code
changes:
  - field: status
    from: todo
    to: done
  - field: checklist.ck_2fbf3aa7.checked
    from: "false"
    to: "true"
-->
...
id: evt_031ae5bb
kind: update
occurred_at: 2026-08-07T13:30:10.511Z
actor:
  type: agent
  id: claude-code
  name: Claude Code
changes:
  - field: checklist.ck_6ee49a21.checked
    from: "false"
    to: "true"
  - field: checklist.ck_f7d23036.checked
    from: "false"
    to: "true"
-->
### Claude Code updated this ticket
