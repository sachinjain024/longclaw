...
create ticket · go to project · change status · ~~assign~~ · set priority ·
...
terminal (Phase 2 slot, visible but disabled). "Change project theme" ships in
the palette per the brief's proposal.

> **ADR 0001 (2026-07-28), amended 2026-08-01 by founder acceptance of P1:**
> "assign" is dropped from the v0 palette — no assignee exists in local mode.
> Set priority, view-toggle, archive (ADR 0004), and board-ordering (ADR 0003)
> are accepted v0 commands. The terminal remains visible but disabled until
> Phase 2; see `../prototype/README.md` § Proposals.
