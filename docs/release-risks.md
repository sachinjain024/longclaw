...
| A ticket directory carries a prefix that is not this project's key and is indexed as if it were | Format | V0-03 | Mismatched prefixes degrade with a diagnostic and are never silently indexed |
